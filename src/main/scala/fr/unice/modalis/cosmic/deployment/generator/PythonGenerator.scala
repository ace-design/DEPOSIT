...
*/
    ...
    case a:Rename[T] =>
      ...
      val output_var = Variable(a.id + "_" + a.output.name, "")
      Instruction(
        Set(input_var),
        input_var.name + "[\"data\"][\"" + DataType.factory(a.iType.getSimpleName).asInstanceOf[SensorDataType].getNameField.n + "\"] = \"" + a.newName + "\";" +
