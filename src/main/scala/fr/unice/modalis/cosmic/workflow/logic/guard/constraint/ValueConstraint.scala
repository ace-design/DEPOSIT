 ...
 */
case class ValueConstraint[T<:DataType](val value: T, val threshold: Int, val operator: String) extends Constraint {
  ...
  override def toString(): String = value.value + "\\" + operator + threshold
